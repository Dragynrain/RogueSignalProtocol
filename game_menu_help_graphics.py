    ...
    def _build_page_controls_mechanics(self) -> dict:
        ...
        return {
            ...
            'text_lines': [
                ...
                (2, 15, "Reach gateway to advance", Colors.WHITE),
                (2, 16, "Avoid trace/detection", Colors.YELLOW),
                (2, 17, "Death = Save deleted!", Colors.RED),

                (2, 19, "HEAT:", Colors.CYAN),
                (2, 20, "Builds from exploits", Colors.WHITE),
                (2, 21, "Damage at 100C+", Colors.RED),
                (2, 22, "Use cooling nodes", Colors.LIGHT_GRAY),

                (2, 24, "TRACE:", Colors.CYAN),
                (2, 25, "Rises when spotted", Colors.WHITE),
                (2, 26, "Admin spawns @ max", Colors.RED),
                (2, 27, "Ghost nodes reduce", Colors.LIGHT_GRAY),
