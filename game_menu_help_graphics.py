    ...
    def _build_page_controls_mechanics(self) -> dict:
        ...
        return {
            ...
            'text_lines': [
                ...
                (5, 14, "OBJECTIVE:", Colors.CYAN),
                (5, 15, "Reach gateway to advance", Colors.WHITE),
                (5, 16, "Avoid trace/detection", Colors.YELLOW),
                (5, 17, "Death = Save deleted!", Colors.RED),

                (5, 19, "HEAT:", Colors.CYAN),
                (5, 20, "Builds from exploits", Colors.WHITE),
                (5, 21, "Damage at 100C+", Colors.RED),
                (5, 22, "Use cooling nodes", Colors.LIGHT_GRAY),

                (5, 24, "TRACE:", Colors.CYAN),
                (5, 25, "Rises when spotted", Colors.WHITE),
                (5, 26, "Admin spawns @ max", Colors.RED),
                (5, 27, "Ghost nodes reduce", Colors.LIGHT_GRAY),
