    ...
    def _build_page_controls_mechanics(self) -> dict:
        ...
        return {
            ...
            'text_lines': [
                ...
                (2, 11, "?: Help  ESC: Menu", Colors.WHITE),

                (2, 13, "OBJECTIVE:", Colors.CYAN),
                (2, 14, "Reach gateway to advance", Colors.WHITE),
                (2, 15, "Avoid trace/detection", Colors.YELLOW),
                (2, 16, "Death = Save deleted!", Colors.RED),

                (2, 18, "HEAT:", Colors.CYAN),
                (2, 19, "Builds from exploits", Colors.WHITE),
                (2, 20, "Damage at 100C+", Colors.RED),
                (2, 21, "Use cooling nodes", Colors.LIGHT_GRAY),

                (2, 23, "TRACE:", Colors.CYAN),
                (2, 24, "Rises when spotted", Colors.WHITE),
                (2, 25, "Admin spawns @ max", Colors.RED),
                (2, 26, "Ghost nodes reduce", Colors.LIGHT_GRAY),

                # Right column - Exploits & Shadows
                (42, 5, "COMBAT EXPLOITS:", Colors.CYAN),
                (42, 6, "BufferOverflow: 40dmg melee", self.NEON_PINK),
                (42, 7, "CodeInject: 25dmg 5range", self.NEON_PINK),
                (42, 8, "SystemCrash: 30dmg disable", self.NEON_PINK),
