...
# Import from main file for now since game_core has older versions
# from game_core import GameStateManager, TurnProcessor, MessageLog
...
# Core game classes that need to be defined here until fully extracted
class MessageLog:
