#!/usr/bin/env python3
"""
Drunk Agent - Random Movement to Find Crashes

A simple agent that randomly walks around like a drunk player.
Great for finding movement-related crashes, edge cases, and pathfinding bugs.
"""
...
class TestDrunkAgent:
    ...
    def test_drunk_on_multiple_seeds(self):
        """Run drunk agent tests on multiple random seeds to find seed-specific bugs."""
        crashes = []
    ...
    def test_long_drunk_session(self):
