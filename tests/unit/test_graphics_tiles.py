...
class TestSpriteConfiguration:
    ...
    def test_all_enemy_types_have_sprite_config(self, tile_manager):
        ...
        expected_enemies = [
            'Scanner', 'Patrol', 'Bot', 'Hunter',
            'Virus', 'Inhibitor', 'Firewall', 'Admin Avatar'
        ]
    ...
    def test_item_sprites_configured(self, tile_manager):
        ...
        expected_items = [
            'codehack', 'exploit', 'cooling_node', 'cooling_upgrade',
            'cpu_node', 'cpu_upgrade', 'ram_upgrade', 'ghost_node'
        ]
