...
from rsp.ui.menu_controls import (  # noqa: E402
    ControlsMenuHub,
    GamepadBindingsMenu,
    GamepadSettingsMenu,
    KeyboardBindingsMenu,
)
from rsp.ui.menu_graphics_preview import GraphicsPreviewMenu  # noqa: E402
...
def log_exception(e: Exception, context: str, level: str = "error"):
    ...
    if level == "critical":
        try:
            from rsp.utils.debug_export import export_crash_report
    ...
    if action == "exit":
        ...
        if active_game is not None:
            ...
            try:
                ...
                from rsp.systems.save import SaveLoadError
...
def main():
    ...
    from rsp.systems.achievements import AchievementManager
    from rsp.systems.metrics import load_unlocked_achievements
    ...
    from rsp.core.platform import get_platform_name
