...
class GameLevelCoordinator:
    ...
    def generate_procedural_level(self, skip_level_start_message: bool = False):
        ...
        from rsp.combat.inventory import sync_code_discovered_status
    ...
    def progress_to_next_level(self):
        ...
        from rsp.systems.metrics import complete_level_metrics, get_current_session, track
        ...
        if self.game_engine.level > 3:
            ...
            from rsp.core.data_loading import get_level_transition_messages
