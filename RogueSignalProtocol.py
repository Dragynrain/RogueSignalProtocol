#!/usr/bin/env python3
"""
Rogue Signal Protocol v48 - Fixed Version
...
def render_ui(console, game):
    """Render the UI panel"""
    # Clear panel area with proper modern tcod syntax
    console.rgb[0:SCREEN_WIDTH, PANEL_Y:PANEL_Y+PANEL_HEIGHT] = ord(' '), Colors.ui_text, Colors.ui_bg
...
def main():
    ...
    context_args = {
        ...
        "rows": SCREEN_HEIGHT,
        "title": "Rogue Signal Protocol v48 - Fixed Hacker Stealth Dungeon Crawler",
        "vsync": True
    }
    ...
    with tcod.context.new(**context_args) as context:
        ...
        game.add_message("Welcome to Rogue Signal Protocol v48 - FIXED!")
