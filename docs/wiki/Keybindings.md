...
- Home/End/PgUp/PgDn - Diagonal movement
...
|-----|--------|-------------|
| **1-5** | Use Exploits | Activate equipped exploits (shown in HUD) |
...
### Most Used Controls
```
Movement:   Arrow Keys, WASD, QEZC, Numpad
Exploits:   1-5 (number keys)
Wait:       Space or .
Inventory:  I
Look Mode:  L
Help:       ?
...
- **Flexible controls** - Multiple input schemes (arrows/WASD/numpad/Vi-keys)
- **Visual feedback** - Hover highlights and visual indicators
