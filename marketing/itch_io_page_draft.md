...
## Screenshots Needed
1. Main menu (animated or static)
2. Stealth gameplay (player hiding in shadows, enemies patrolling)
3. Combat encounter (player using exploits against enemies)
4. Lore/Fragments screen (story discovery)
5. Inventory screen (exploit management)

---

## Tags for itch.io

**Genre:** roguelike, stealth, strategy
**Theme:** cyberpunk, sci-fi, dystopian
**Features:** turn-based, procedural-generation, permadeath, story-rich
**Misc:** retro, ascii, singleplayer, free

---

## Pricing
**Recommended:** Pay what you want (minimum $0)
**Alternative:** Completely free

---

## Project Classification
* **Release Status:** In development - Alpha
